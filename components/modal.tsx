...
export default function Modal(props: ModalProps) {
  ...
  return (
    <div aria-hidden="true" id="modal-winner" className="fixed flex top-0 left-0 right-0 z-50 w-full p-4 overflow-hidden overflow-y-auto md:inset-0 h-full bg-black bg-opacity-60">
